      ...
      <div class="card" style="cursor:pointer;position:relative;overflow:hidden" onclick="AdminsPage.showDetail(${a.id})">
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;padding-right:100px">
          <div style="position:relative;width:52px;height:52px;min-width:52px">
            ${a.plan_status === 'active' ? `<svg viewBox="0 0 52 52" width="52" height="52" style="position:absolute;top:0;left:0;pointer-events:none;filter:drop-shadow(0 0 5px rgba(255,68,68,0.6)) drop-shadow(0 0 3px rgba(68,138,255,0.5))"><circle cx="26" cy="26" r="23.5" fill="none" stroke-width="3.5" stroke-dasharray="29.53 118.12" stroke-dashoffset="0" stroke="#FF4444" stroke-linecap="round"/><circle cx="26" cy="26" r="23.5" fill="none" stroke-width="3.5" stroke-dasharray="29.53 118.12" stroke-dashoffset="-29.53" stroke="#FFB800" stroke-linecap="round"/><circle cx="26" cy="26" r="23.5" fill="none" stroke-width="3.5" stroke-dasharray="29.53 118.12" stroke-dashoffset="-59.06" stroke="#00E676" stroke-linecap="round"/><circle cx="26" cy="26" r="23.5" fill="none" stroke-width="3.5" stroke-dasharray="29.53 118.12" stroke-dashoffset="-88.59" stroke="#448AFF" stroke-linecap="round"/><circle cx="26" cy="26" r="23.5" fill="none" stroke-width="3.5" stroke-dasharray="29.53 118.12" stroke-dashoffset="-118.12" stroke="#E040FB" stroke-linecap="round"/></svg>` : ''}
