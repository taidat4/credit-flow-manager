      ...
      <div class="card" style="cursor:pointer;position:relative;overflow:hidden" onclick="AdminsPage.showDetail(${a.id})">
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;padding-right:100px">
          <div style="position:relative;width:52px;height:52px;min-width:52px">
            ${a.plan_status === 'active' ? `<svg viewBox="0 0 52 52" width="52" height="52" style="position:absolute;top:0;left:0;pointer-events:none;filter:drop-shadow(0 0 6px rgba(255,68,68,0.7)) drop-shadow(0 0 4px rgba(68,138,255,0.6))"><path d="M26,2.5 A23.5,23.5 0 0,1 48.38,18.26" fill="none" stroke="#FF4444" stroke-width="4" stroke-linecap="round"/><path d="M48.38,18.26 A23.5,23.5 0 0,1 40.12,45.04" fill="none" stroke="#FFAA00" stroke-width="4" stroke-linecap="round"/><path d="M40.12,45.04 A23.5,23.5 0 0,1 11.88,45.04" fill="none" stroke="#00E676" stroke-width="4" stroke-linecap="round"/><path d="M11.88,45.04 A23.5,23.5 0 0,1 3.62,18.26" fill="none" stroke="#448AFF" stroke-width="4" stroke-linecap="round"/><path d="M3.62,18.26 A23.5,23.5 0 0,1 26,2.5" fill="none" stroke="#E040FB" stroke-width="4" stroke-linecap="round"/></svg>` : ''}
